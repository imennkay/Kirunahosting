function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, tax: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}const { Component, PropTypes } = React;
...
class List extends Component {constructor(...args) {super(...args);_defineProperty(this, "state",
    {
      ...
      { id: 'item_1001',
        src: './images/1mp.jpg',
        name: '1månad MEDIUM WEBBHOTELL',
        cost: 139,
        qty: 0 },
        { id: 'item_1002',
        src: './images/12mp.jpg',
        name: '12månad MEDIUM WEBBHOTELL',
        cost: 675,
        qty: 0 },
        { id: 'item_1003',
        src: './images/24mp.jpg',
        name: '24månad MEDIUM WEBBHOTELL',
        cost: 1050,
        qty: 0 }],
    ...
    render() {
      return (
        ...
        React.createElement("a", { className: "order_btn", href: "Faktura.pdf", onClick: () => this.document() }, "Faktura"))) :
